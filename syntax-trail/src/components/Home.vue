...
const languages = ref([
  { name: 'JavaScript', logo: '/src/assets/javascript.png', path: '/javascript' },
  { name: 'Python', logo: '/src/assets/python.png', path: '/python' },
  { name: 'Java', logo: '/src/assets/java.png', path: '/java' },
  { name: 'C++', logo: '/src/assets/cplusplus.png', path: '/cplusplus' },
  { name: 'C#', logo: '/src/assets/csharp.png', path: '/csharp' },
  { name: 'Ruby', logo: '/src/assets/ruby.png', path: '/ruby' },
  { name: 'PHP', logo: '/src/assets/php.png', path: '/php' },
  { name: 'Swift', logo: '/src/assets/swift.png', path: '/swift' },
  { name: 'Go', logo: '/src/assets/go.png', path: '/go' },
  { name: 'Rust', logo: '/src/assets/rust.png', path: '/rust' },
  { name: 'SQL', logo: '/src/assets/sql.png', path: '/sql' },
  { name: 'Kotlin', logo: '/src/assets/kotlin.png', path: '/kotlin' },
  { name: 'TypeScript', logo: '/src/assets/typescript.png', path: '/typescript' },
  { name: 'R', logo: '/src/assets/r.png', path: '/r' },
  { name: 'ShellScript', logo: '/src/assets/shell.png', path: '/shellscript' },
  { name: 'MATLAB', logo: '/src/assets/matlab.png', path: '/matlab' },
  { name: 'Dart', logo: '/src/assets/dart.png', path: '/dart' },
])
