...
<template>
  ...
  <header class="hero">
    ...
    <p>Syntax Trail is a platform dedicated to making programming knowledge accessible to everyone. It offers resources
  ...
  <header class="hero">
    ...
    <p>Syntax Trail was developed by <span class="highlight">Minela Mašinović</span>, a 20-year-old Business Informatics
    ...
    <p>It is <span class="highlight">Minela's</span> first published project and was entirely self-developed. The idea
      ...
      languages. Syntax Trail was created to fill that gap and serve as a valuable tool for anyone starting their coding
      journey.
    </p>
  </header>
